...
main ()
{
  ...
  apt_source_path="/etc/apt/sources.list.d/eugeny_tabby.list"
...
# Then install tabby
sudo apt-get update
wget https://github.com/Eugeny/tabby/releases/download/v1.0.201/tabby-1.0.201-linux-x64.deb
gdebi tabby-1.0.201-linux-x64.deb
rm tabby-1.0.201-linux-x64.deb
